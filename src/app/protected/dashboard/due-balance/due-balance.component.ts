...
export class DueBalanceComponent {
  ...
  calculateDueAmounts() {
    ...
    this.last30DaysDueAmount = this.calculateDueAmountInRange(last30DaysDate, currentDate);
    this.last90DaysDueAmount = this.calculateDueAmountInRange(last90DaysDate, currentDate);
    this.allTimeDueAmount = this.calculateDueAmountInRange(new Date(0), currentDate);
  }
