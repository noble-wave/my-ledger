  ...
  getCustomerSellsData() {
    ...
    this.customerSells$ = forkJoin([
      ...
      map((res: any[]) => {
        ...
        let customerSells = sells.filter((sell) => sell.customerId === this.customerId);
        ...
        this.totalDueAmount = customerSells?.reduce((a, b) => a + (Number(b.dueAmount) || 0), 0);
